...
export default function IDCard() {
    ...
    try {
      ...
      const html = `<html>
          <style>
            ...
            <body>
                <div id="mcontainer">
                    <h1 style="color: #2B2B2B;" >Class I  Sec A</h1>
                    ${str}
            </div>
            </body>
      </html>`;
      ...
      console.log(RNFS);
      //   await RNFS.moveFile(file.filePath, RNFS.DocumentDirectoryPath);
  ...
  return (
    ...
    >
      ...
      <Button title="Download" onPress={generatePDF}></Button>
    </View>
  );
}
